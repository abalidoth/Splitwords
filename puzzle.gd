...
@export var square_to_slot: Dictionary[Vector2i, Array]
@export var char_masks: Dictionary[Vector2i, Array]
@export var update_queue: Array
@export var backtrack_choices: Array

@export var slot_to_word_id: Array[int]

@export var slot_to_word: Array[String]

@export var slot_to_clue: Array[String]

@export var obscurity: int #between 20 and 100

@export var completed_puzzle:Dictionary[Vector2i, int]

@export var state = AlgState.SETTLING
